...
function reservationRowHtml(r) {
    ...
    <div class="flex items-start justify-between gap-3 bg-gray-50 rounded-xl p-4 border border-gray-100" data-reservation-id="${escapeAttr(r.id)}">
      ...
      <div class="flex gap-1 shrink-0">
        <button onclick="openReservationForm('${escapeAttr(r.id)}')" class="text-gray-500 gt-hover-accent p-2 rounded-lg hover:bg-white transition-colors" title="עריכה" aria-label="עריכת הזמנה">✏️</button>
