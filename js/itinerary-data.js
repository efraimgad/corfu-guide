...
window.ITINERARY_DAYS = [
    ...
    },
    {
        ...
        dayBrief: {
            ...
            mustDo: [
                ...
                { title: `המבצר הישן`, why: `תצפית 360 מעלות על העיר, המפרץ והרי אלבניה. העלייה מתונה אבל היא כן עלייה.` }
            ],
            recommended: [
    ...
    },
    {
        ...
        dayBrief: {
            ...
            mustDo: [
                ...
                { title: `מנזר פלאוקסטריצה מוקדם בבוקר`, why: `מנזר מ-1228 על צוק מעל המפרצים. מוקדם זה שקט; מאוחר זה תור.` }
            ],
            recommended: [
    ...
    },
    {
        ...
        dayArea: "דרום קורפו",
        dayBrief: {
            theme: `היום הכי ארוך בהגה - ובכוונה`,
            pace: "active",
            bestFor: ["nature", "sightseeing", "food", "beach"],
            overview: `<p>הדרום הוא החלק של קורפו שרוב המבקרים מוותרים עליו, וזו בדיוק הסיבה ללכת אליו: דיונות חול ואגם מלוח שנראים כאילו נלקחו ממדינה אחרת, כפרי הרים שקטים, וטברנות דגים בלי תפריט באנגלית. אבל צריך להגיד את זה בפירוש - <strong>זה היום עם הכי הרבה נהיגה בטיול, בהפרש ניכר</strong>. הדרום פשוט רחוק, לא בגלל שהמסלול מתפתל.</p>
                <p>נקודה שכדאי לדעת לפני שמקצים לאכיליון שעתיים וחצי: לפי הביקורות שנאספו, <strong>פנים הארמון סגור לשיפוצים מאז 2021</strong> והביקור הוא בגנים החיצוניים בלבד. הגנים באמת יפים, אבל אם הם לבדם - זה ביקור של שעה, לא של שעתיים וחצי, וההפרש הזה שווה בוקר שלם. כדאי לאמת את זה לפני היציאה.</p>`,
            mustDo: [
                { title: `דיונות איסוס ואגם קוריסיון`, why: `אין עוד מקום כזה באי - רצועת חול בין ים לאגם, שקטה ופראית. זה מה שהופך את הנסיעה הארוכה למשתלמת.` },
                { title: `ארוחת דגים בבוקארי`, why: `כפר דייגים על קו המים בצד המזרחי השקט. זו הארוחה שאנשים זוכרים מהדרום.` }
            ],
            recommended: [
                { title: `גני ארמון אכיליון`, why: `פסלים, מרפסות ונוף למפרץ - בתנאי שאתם מגיעים עם הציפייה הנכונה לגבי הפנים הסגור.` },
                { title: `הכפר חלומוס`, why: `כפר הררי קטן עם תצפית על כל הדרום. עצירה קצרה, לא יעד.` }
            ],
            optional: [
                { title: `שחייה בחליקונאס`, why: `רק אם הרוח נוחה - הצד הזה חשוף, והים כאן לא תמיד רגוע כמו במזרח.` }
            ],
            ifTired: `<p>בין 16:30 ל-19:00 יש ביום הזה כשעתיים וחצי בלי תוכנית קבועה - זה מכוון, וזה גם הבלם שלכם. אם היום מרגיש ארוך, פשוט אל תמלאו אותן: שבו בבוקארי מול המים עד ארוחת הערב, או ותרו על חלומוס וסעו חזרה מוקדם. הדרך חזרה למלון היא עוד 38 דקות אחרי הארוחה, וכדאי לקחת אותן בחשבון.</p>`,
            ifEnergy: `<p>אם יצאתם בזמן ואכיליון התברר כביקור קצר, אפשר להוסיף עצירה קצרה בבניצס בדרך דרומה - היא ממש על הכביש הראשי ולא מוסיפה נסיעה של ממש.</p>`,
            skipFirst: `חלומוס. התצפית יפה אבל היא התוספת הכי קלה לוותר עליה, והיא זו שדוחפת את הארוחה והנסיעה חזרה מאוחר יותר.`,
            weather: {
                sun: `<p>קחו יותר מים ממה שנראה לכם שצריך. באיסוס ובחליקונאס אין צל, אין קיוסק ואין מקלט מהשמש - זה אזור טבע מוגן, לא חוף מאורגן. כובע וקרם הם לא בגדר המלצה כאן.</p>`,
                cloud: `<p>יום מעונן דווקא מקל על היום הזה: הדיונות והאגם נוחים בהרבה בלי שמש ישירה, והנהיגה הארוכה פחות מתישה. זה כנראה מזג האוויר האידיאלי ליום הזה.</p>`
            },
            highlights: [
                `רצועת החול בין הים היוני לאגם קוריסיון`,
                `ארוחת דגים על קו המים בבוקארי`,
                `הדרום השקט שרוב המבקרים בקורפו לא רואים`
            ],
            bestMoment: `הרגע שבו עוצרים בין הים לאגם באיסוס ומבינים כמה שקט יש שם לעומת שאר האי.`
        },
        transitions: {
            fromHotel: null,
            between: [
