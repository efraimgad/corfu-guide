...
window.ITINERARY_DAYS = [
    {
        ...
        dayBrief: {
            ...
            sunsetNote: `אתם נוחתים בערך בשעה שהשמש שוקעת, אז את השקיעה הראשונה תראו כנראה מהכביש - וזה בסדר גמור. הארוחה ליד המלון תהיה כבר בחשכה נעימה.`,
            highlights: [
    ...
    },
    {
        ...
        dayBrief: {
            theme: `בוקר חופשי, הפסקה במלון בצהריים, כל השאר ברגל`,
            pace: "balanced",
            bestFor: ["sightseeing", "history", "food", "couples", "shopping"],
            overview: `<p>קורפו טאון היא לא "עוד עיר עתיקה יוונית" - היא ונציאנית. ארבע מאות שנה של שלטון ונציאני, ואחריהן צרפתים ובריטים, הותירו עיר שנראית ומרגישה קרוב יותר לאיטליה: קשתות, תריסים, כביסה בין הבניינים, ומגרש קריקט בלב הכיכר המרכזית - היחיד ביוון.</p>
                <p>הבוקר הזה חופשי לגמרי - אין שעון מעורר, ואין יותר אילוץ של "להגיע לפני 09:00". הבאפה במלון פתוח עד 10:30, כך שאפשר לרדת בנחת גם ב-9:30-10:00. חונים בחניון הנמל הישן (Old Port Parking) - חניון גדול בתעריף יומי קבוע, זול משמעותית מהחניה השעתית בספיאנדה אם נשארים כמה שעות - ומשם הליכה נעימה לאורך הטיילת עד הליסטון. את הצהריים החמים (14:30-16:30) מבלים בהפסקה חזרה במלון, ורק אחר כך חוזרים לעיר להמשך היום. קאנוני וולכרנה בסוף היום אופציונליים לגמרי, לפי כוח.</p>`,
            mustDo: [
            ...
            recommended: [
                ...
                { title: `הפסקה במלון בצהריים`, why: `שעתיים בין 14:30 ל-16:30 לחזור, לנוח ואם בא לכם - לקפוץ לבריכה (פתוחה 11:00-20:00, מגבת בפיקדון של €10). בדיוק השעות הכי חמות של היום.` },
                { title: `סבונים וליקר קומקוואט בקמפיילו`, why: `מפעל הסבון פטוניס פתוח לביקור חינם ממש בלב הרובע, ואתם כבר עוברים לידו. זה גם המקום הכי טבעי בטיול לקנות מזכרת שהיא לא מגנט - סבון שמן זית או בקבוק ליקר קומקוואט.` },
                { title: `סדנאות האומנים של ניקיפורו תיאוטוקי`, why: `הרחוב הראשי של העיר העתיקה הוא גם הרחוב שבו עוד באמת מייצרים: אצל טום הכול מגולף מעץ זית במקום, ואצל פירסטינג ונואל הקרמיקה נשרפת באטלייה שמאחורי החנות. שתיהן במרחק דקות הליכה זו מזו.` },
                { title: `קאנוני ומנזר ולכרנה`, why: `גשר הולכי רגל אל המנזר, ומטוסים שנוחתים ממש מעל הראש - אבל זו יציאה נוספת, לא המשך מובן מאליו של היום. אם הצהריים כבר היו ארוכים, לחזור למלון באותה מידה נכון.` }
            ],
            optional: [
                { title: `כנסיית סנט ספירידון`, why: `פטרון האי, במרכז הקמפיילו ממילא. עצירה של עשר דקות בתוך מסלול ההליכה.` },
                { title: `רולנדוס - תכשיטים בעבודת יד`, why: `אם תכשיטים מעניינים אתכם, זו הכתובת בעיר: משפחה שעובדת באותה סדנה כבר דורות, ואפשר לראות את העבודה עצמה מאחורי הדלפק.` },
                { title: `השוק העירוני`, why: `שמן זית, דבש, קומקוואט ותבלינים במקום שבו העיר קונה לעצמה. סוגר אחר הצהריים המוקדמות ולא פועל בימי ראשון, אז זה עניין של בוקר.` }
            ],
            ifTired: `<p>וותרו על החזרה לעיר אחר ההפסקה במלון: קמפיילו, ספירידון וקאנוני הם כולם תוספת, לא חובה, וערב רגוע במלון עדיף על יום עמוס מדי. אפשר גם לקצר את המבצר הישן - להיכנס, להסתובב בחצר ולוותר על הטיפוס עד הצלב שבפסגה.</p>`,
            ...
            skipFirst: `קאנוני. הוא היחיד שדורש לקחת את הרכב שוב בסוף היום, ולכן הראשון שיורד אם ההפסקה במלון התארכה.`,
            weather: {
                sun: `<p>ההפסקה במלון בין 14:30 ל-16:30 כבר מכסה את השעות הכי חמות של היום, כך שהחלק הקשה של החום כמעט ולא פוגע בסיור. בבוקר ובערב, הליסטון והסמטאות הצרות של הקמפיילו נותנים צל טוב.</p>`,
                cloud: `<p>אם מעונן, אפשר לקצר את ההפסקה במלון ולהאריך את הזמן בעיר במקומה - הבריכה בכל מקרה פחות מפתה ביום כזה, וההליכה בעיר נוחה בהרבה בלי שמש.</p>`
            },
            sunsetNote: `קאנוני פונה מערבה מעל הלגונה והוא אחד המקומות היפים בעיר לאור אחרון. אם אתם עדיין שם, אין סיבה למהר - הארוחה יכולה לחכות.`,
            highlights: [
        ...
        dayArea: "מרכז קורפו",
        closingNoteHtml: `<p>😌 <strong>קחו את הזמן:</strong> הבוקר הזה בנוי כך שאין לחץ בשום נקודה - גם אם התיישבתם לקפה מול הליסטון ונשארתם שעה נוספת, או שקיצרתם את המבצר, יש עוד הפסקה שלמה במלון לפני שממשיכים. ולוותר על קאנוני בסוף היום לא חייב להיות ויתור על כלום - זה פשוט עוד ערב רגוע, לא כי נגמר הכוח אלא כי זה בדיוק היום לעשות את זה.</p>`,
        transitions: {
            fromHotel: null,
            between: [
                { mode: "drive", min: 18, km: 8, parking: "חניון הנמל הישן (Old Port Parking) - חניה ליום שלם" },
                { mode: "walk", min: 5, m: 400 },
                { mode: "walk", min: 7, m: 500 },
                { mode: "drive", min: 18, km: 8, parking: "חזרה למלון להפסקה" },
                { mode: "drive", min: 18, km: 8, parking: "חזרה לחניון הנמל הישן" },
        ...
        items: [
            { time: "08:00-10:30", title: `☕ קימה חופשית וארוחת בוקר`, html: `<div class="premium-event-desc"><p>בלי שעון מעורר. ארוחת הבוקר במלון <span class="trip-private-hotel-name">המלון שלכם</span> מוגשת כבאפה מלא בין 08:00 ל-10:30 (לפי דף המידע מהמלון בחדר), כך שאפשר לרדת מתי שנוח - גם ב-9:30-10:00 - ועדיין לשבת בלי לחץ.</p><ul class="space-y-1.5 text-sm mt-3"><li class="flex items-center gap-2"><span class="text-amber-600 shrink-0">💶</span><span><strong class="font-semibold text-gray-900">עלות:</strong> כלול במלון</span></li><li class="flex items-center gap-2"><span class="text-blue-600 shrink-0">⏱️</span><span><strong class="font-semibold text-gray-900">משך מומלץ:</strong> לפי מה שנוח - עד 10:30</span></li><li class="flex items-center gap-2"><span class="text-purple-600 shrink-0">✨</span><span><strong class="font-semibold text-gray-900">אווירה:</strong> רגוע לגמרי - אין שום לחץ בוקר</span></li></ul></div>
                            <div class="premium-tip-box">
                                <p class="flex items-start gap-2"><span class="text-lg">🚗</span> <span><strong>שני דברים לזכור לגבי הרכב:</strong> תחנו רק באחד מ-6 מקומות החניה ליד המלון או ב-6 הנוספים ליד המיני-מרקט - לא ברחוב.</span></p>
                                <p class="flex items-start gap-2"><span class="text-lg">🔑</span> <span><strong>חזרה מאוחרת:</strong> אם תחזרו למלון אחרי 23:30, הקוד לכניסה הוא 4000 בפעמון.</span></p>
                            </div>` },
            { time: "10:30-11:00", title: `🚗☕ יציאה לעיר וקפה בליסטון`, html: `<div class="premium-event-desc"><p>סעו לקורפו טאון (כ-8 ק"מ, 15-20 דקות) וחנו בחניון הנמל הישן (Old Port Parking, ליד המבצר החדש / הנמל הישן) - חניון גדול עם ביקורות טובות, כ-5€ ליום שלם, במקום כ-3€ לשעה בספיאנדה. אם אתם בעיר כמה שעות זה יוצא הרבה יותר זול, והחניון גם לא מתמלא כמו המרכזי - אין יותר לחץ להגיע מוקדם. מהחניון, הליכה נעימה של כ-10-15 דקות לאורך הטיילת עד הליסטון - קטע נחמד בפני עצמו, לא רק דרך. שבו באחד מבתי הקפה האלגנטיים בטיילת הליסטון המפורסמת שנבנתה בהשראת רחוב ריבולי בפריז, הזמינו קפה פרדו וצפו בעיר מתעוררת לחיים מול כיכר הספיאנדה הרחבה. בקצה הצפוני של הספיאנדה שוכן מגרש הקריקט היחיד ביוון, שהוקם עוד בתקופת השלטון הבריטי במאה ה-19 ופעיל עד היום.</p><ul class="space-y-1.5 text-sm mt-3"><li class="flex items-center gap-2"><span class="text-amber-600 shrink-0">💶</span><span><strong class="font-semibold text-gray-900">עלות:</strong> כ-5€ חניה ליום + כ-4-6€ לקפה</span></li><li class="flex items-center gap-2"><span class="text-blue-600 shrink-0">⏱️</span><span><strong class="font-semibold text-gray-900">משך מומלץ:</strong> כחצי שעה, לא כולל ההליכה</span></li><li class="flex items-center gap-2"><span class="text-purple-600 shrink-0">✨</span><span><strong class="font-semibold text-gray-900">אווירה:</strong> אלגנטי ואירופאי - נהדר לצפייה בעיר מתעוררת</span></li></ul></div>
                            <div class="premium-tip-box">
                                <p class="flex items-start gap-2"><span class="text-lg">🚗</span> <span><strong>איתור החניון:</strong> חפשו "Old Port Parking Corfu" ב-Google Maps כשתגיעו - אין קואורדינטה מדויקת שמורה כמו לספיאנדה, אז כדאי לוודא במקום.</span></p>
            ...
            { time: "13:00-14:30", title: `🍽️ ארוחת צהריים מסורתית`, html: `<div class="premium-event-desc"><p>שבו באחת הטברנות בעיר העתיקה (למשל Marina's Tavern), במרחק הליכה מהמבצר. חובה לטעום את המנות הקורפיות הקלאסיות: Pastitsada (פסטה עם תבשיל בקר בתבלינים) או Sofrito (בקר ברוטב יין לבן ושום).</p><ul class="space-y-1.5 text-sm mt-3"><li class="flex items-center gap-2"><span class="text-amber-600 shrink-0">💶</span><span><strong class="font-semibold text-gray-900">עלות:</strong> כ-15-20€ למנה</span></li><li class="flex items-center gap-2"><span class="text-blue-600 shrink-0">⏱️</span><span><strong class="font-semibold text-gray-900">משך מומלץ:</strong> שעה - שעה וחצי</span></li><li class="flex items-center gap-2"><span class="text-purple-600 shrink-0">✨</span><span><strong class="font-semibold text-gray-900">אווירה:</strong> אותנטי - טברנה מקומית בלב העיר העתיקה</span></li></ul></div>` },
            { time: "14:30-16:30", title: `🏨 הפסקה במלון - חוזרים לנוח`, html: `<div class="premium-event-desc"><p>סעו חזרה למלון (כ-15-20 דקות) להפסקה אמיתית באמצע היום - בדיוק בשעות הכי חמות. אם בא לכם לקפוץ למים, הבריכה פתוחה 11:00-20:00 (מגבת בפיקדון של €10).</p><ul class="space-y-1.5 text-sm mt-3"><li class="flex items-center gap-2"><span class="text-amber-600 shrink-0">💶</span><span><strong class="font-semibold text-gray-900">עלות:</strong> ללא עלות (מלבד פיקדון מגבת €10, מוחזר)</span></li><li class="flex items-center gap-2"><span class="text-blue-600 shrink-0">⏱️</span><span><strong class="font-semibold text-gray-900">משך מומלץ:</strong> שעתיים</span></li><li class="flex items-center gap-2"><span class="text-purple-600 shrink-0">✨</span><span><strong class="font-semibold text-gray-900">אווירה:</strong> נינוח - הפסקה אמיתית באמצע היום</span></li></ul></div>` },
            { time: "16:30-18:00", title: `⭐ קמפיילו (Campiello) וכנסיית סנט ספירידון`, html: `<div class="premium-event-desc"><p>סעו חזרה לעיר (חנו שוב בחניון הנמל הישן) ולכו לאיבוד בסמטאות הצרות והציוריות של הרובע העתיק. הבניינים בצבעי פסטל עם כביסה תלויה מזכירים את נאפולי. בקרו בכנסיית סנט ספירידון (פטרון האי), הציצו למפעל הסבון פטוניס (Patounis) הסמוך - סיור פנימי חינמי במפעל מסורתי לסבוני שמן זית - ורכשו מזכרות מקומיות כמו סבון משם או ליקר קומקוואט. באותן סמטאות, על רחוב ניקיפורו תיאוטוקי וסביבו, עובדות עד היום כמה סדנאות קטנות: בית המלאכה לעץ זית של טום (Olive Wood Workshop), הקרמיקה של פירסטינג ונואל (Firsthing &amp; Noel), וסדנת התכשיטים של רולנדוס (Rolandos) - כולן במרחק הליכה זו מזו.</p><ul class="space-y-1.5 text-sm mt-3"><li class="flex items-center gap-2"><span class="text-amber-600 shrink-0">💶</span><span><strong class="font-semibold text-gray-900">עלות:</strong> כניסה לכנסייה ללא עלות (תרומה מומלצת)</span></li><li class="flex items-center gap-2"><span class="text-blue-600 shrink-0">⏱️</span><span><strong class="font-semibold text-gray-900">משך מומלץ:</strong> שעה וחצי</span></li><li class="flex items-center gap-2"><span class="text-purple-600 shrink-0">✨</span><span><strong class="font-semibold text-gray-900">אווירה:</strong> ציורי ואינטימי - מצוין לשוטטות ולצילום</span></li></ul></div>` },
            { time: "אופציונלי, לפי כוח", title: `🌿 קאנוני + ולכרנה + תצפית מטוסים`, html: `<div class="premium-event-desc"><p>סעו כ-15 דקות לחצי האי קאנוני. רדו למנזר Vlacherna האייקוני. לכו על גשר הולכי הרגל החוצה את המפרץ והרגישו את המטוסים נוחתים ממש מעל לראשכם. זו יציאה נוספת ולא המשך מובן מאליו של היום - אם הצהריים כבר היו ארוכים, אפשר לוותר בלי היסוס.</p><ul class="space-y-1.5 text-sm mt-3"><li class="flex items-center gap-2"><span class="text-amber-600 shrink-0">💶</span><span><strong class="font-semibold text-gray-900">עלות:</strong> ללא עלות (מלבד חניה, במידת הצורך)</span></li><li class="flex items-center gap-2"><span class="text-blue-600 shrink-0">⏱️</span><span><strong class="font-semibold text-gray-900">משך מומלץ:</strong> שעה וחצי - שעתיים</span></li><li class="flex items-center gap-2"><span class="text-purple-600 shrink-0">✨</span><span><strong class="font-semibold text-gray-900">אווירה:</strong> ייחודי ומרגש - אטרקציה חינמית ונדירה</span></li></ul></div>
                            <div class="premium-tip-box">
            ...
            { time: "20:00 ואילך", title: `🍽️ ארוחת ערב`, html: `<div class="premium-event-desc"><p>אם עשיתם את קאנוני - סיימו את היום ממש שם, עם ארוחת ערב על קו המים ונוף למפרץ ולמנזר ולכרנה. אם ויתרתם עליו, אותה איכות ארוחה אפשר למצוא גם ליד המלון או בקורפו טאון עצמה.</p><div class="itinerary-dinner-slot" data-dinner-food-id="food-פליסבוס-Flisvos"><p>טוען המלצה...</p></div></div>` }
        ]
    },
    {
        key: "3",
        ...
        dayBrief: {
            ...
            mustDo: [
                { title: `צהריים ארוכים במפרץ אגני`, why: `טברנות שיושבות ממש על קו המים, בלי כביש בין השולחן לים. זה הרגע שרוב האנשים מתארים כשהם מספרים על הצפון-מזרח - השולחן והנוף, לא המנה.` }
            ],
            recommended: [
            ...
            sunsetNote: `קסיופי פונה מזרחה, אז לא תראו את השמש נכנסת לים - אבל הנמל מקבל אור רך ונעים בדיוק בשעה שתשבו לאכול. זו סיבה טובה להישאר שם ולא למהר חזרה.`,
            highlights: [
        ...
        items: [
            ...
            { time: "14:30 ואילך", title: `⭐ צהריים ארוכים במפרץ אגני (Agni Bay)`, html: `<div class="premium-event-desc"><p>אפשר להגיע לאגני בנסיעה קצרה או לקחת מונית מים קטנה מקאלאמי. מפרץ אגני הוא שורה של טברנות שיושבות ממש על קו המים - בלי כביש בין השולחן לים. זה מה שהופך את הצהריים כאן לתחנה המרכזית של היום, לא התפריט. הטברנות כאן ידועות בעיקר בדגים, אז אם אתם לא אוכלי דגים - שווה לשאול בטלפון מה יש מהגריל ובמזטים כשמזמינים מקום ב-<em>Toula's Gastronomy</em> או ב-<em>Taverna Agni</em>.</p><ul class="space-y-1.5 text-sm mt-3"><li class="flex items-center gap-2"><span class="text-amber-600 shrink-0">💶</span><span><strong class="font-semibold text-gray-900">עלות:</strong> כ-30-40€ למנה</span></li><li class="flex items-center gap-2"><span class="text-blue-600 shrink-0">⏱️</span><span><strong class="font-semibold text-gray-900">משך מומלץ:</strong> שעה וחצי - שעתיים</span></li><li class="flex items-center gap-2"><span class="text-purple-600 shrink-0">✨</span><span><strong class="font-semibold text-gray-900">אווירה:</strong> יוקרתי ורגוע - ישיבה על קו המים</span></li></ul></div>` },
            { time: "17:30 בערך", title: `💡 קסיופי (Kassiopi) – אתם ממילא בדרך`, html: `<div class="premium-event-desc"><p>סיימו את היום בקסיופי, כפר דייגים תוסס וגדול יותר. שוטטו סביב הנמל המלא סירות דיג עץ, טפסו להריסות המבצר הביזנטי שמשקיף על העיירה, ושבו באחד הברים על קו המים לדרינק של שקיעה.</p><ul class="space-y-1.5 text-sm mt-3"><li class="flex items-center gap-2"><span class="text-amber-600 shrink-0">💶</span><span><strong class="font-semibold text-gray-900">עלות:</strong> כניסה למבצר ללא עלות</span></li><li class="flex items-center gap-2"><span class="text-blue-600 shrink-0">⏱️</span><span><strong class="font-semibold text-gray-900">משך מומלץ:</strong> שעתיים - שלוש שעות</span></li><li class="flex items-center gap-2"><span class="text-purple-600 shrink-0">✨</span><span><strong class="font-semibold text-gray-900">אווירה:</strong> תוסס ואותנטי - כפר דייגים עם שקיעה מהממת</span></li></ul></div>` },
    ...
    },
    {
        ...
        dayBrief: {
            ...
            overview: `<p>פלאוקסטריצה היא הפוסטר של קורפו, ובצדק: שישה מפרצים ירוקים שנחתכים לתוך צוקים, ומים בצבע שקשה להאמין לו בתמונות. אבל מה שהופך את היום הזה לחריג הוא לא הנוף - זו הסירה. מנוע עד 30 כ"ס לא דורש רישיון, כלומר אתם יכולים לשכור סירה קטנה ולנווט אותה בעצמכם למפרצים שאין אליהם דרך ביבשה.</p>
                ...
                <p>אנגלוקסטרו אינו חובה בשום מובן: הטיפוס הפיזי היחיד ביום מגיע אחרי כבר כמה שעות בסירה בשמש, וזה בדיוק סוג המאמץ שאפשר לוותר עליו בלי לוותר על שום דבר מהותי. לשבת ליד הנמל עם צהריים ארוכים במקום לטפס - זו לא גרסה מקוצצת של אחר הצהריים, היא כנראה הגרסה הנכונה שלו אחרי בוקר כזה.</p>`,
            mustDo: [
            ...
            recommended: [
                ...
                { title: `מבצר אנגלוקסטרו`, why: `טיפוס מתון לתצפית על כל החוף המערבי. הדרך אליו צרה ומתפתלת - סעו לאט. זו התוספת הפיזית היחידה ביום, ולכן גם הראשונה שאפשר לוותר עליה בלי רגשות אשם.` },
            ...
            sunsetNote: `רוביניה פונה ישר למערב וזו אחת השקיעות היפות באי. אם הגעתם לחוף אחר הצהריים, פשוט תישארו - אין שום דבר אחרי זה חוץ מארוחה.`,
            highlights: [
    ...
    },
    {
        ...
        dayBrief: {
            ...
            recommended: [
                ...
                { title: `ארוחה ארוכה בבוקארי`, why: `כפר דייגים קטן על קו המים בצד המזרחי השקט. זו לא עצירה בדרך - זו הארוחה של היום, וכדאי להקצות לה את כל הערב. זה כפר דייגים, אז התפריטים נוטים לדגים - שווה לשאול מראש מה יש מהגריל.` }
            ],
            optional: [
            ...
            ifTired: `<p>ותרו גם על אכיליון וגם על חלומוס. צאו סביב 10:30, הגיעו לדיונות בצהריים, והישארו שם עד שמתחשק לאכול. <strong>זו לא גרסה מקוצצת של היום - זו כנראה הגרסה הנכונה שלו</strong>: היום הזה בא מיד אחרי היום העמוס בשבוע, וזה בדיוק המקום לשים בו את היום האיטי.</p>`,
            ...
            sunsetNote: `בוקארי פונה מזרחה, כך שהשקיעה עצמה לא תיראה מעל הים - אבל האור על המים בשעה הזו הוא בדיוק למה שווה להזמין עוד סיבוב ולא למהר.`,
            highlights: [
        ...
        items: [
            ...
            { time: "17:00 ואילך", title: `🍽️ ארוחה ארוכה בבוקארי (Boukari)`, html: `<div class="premium-event-desc"><p>כפר דייגים קטן ושקט על קו המים, בצד המזרחי של הדרום. <strong>זו לא "ארוחת צהריים" ואחריה "ארוחת ערב" - זו ארוחה אחת ארוכה</strong>, והיא הסיום של היום. שבו מול המים, הזמינו לאט, ואל תסתכלו על השעון.</p><div class="itinerary-dinner-slot" data-dinner-food-id="food-בוקארי-ביץ"><p>טוען המלצה...</p></div><ul class="space-y-1.5 text-sm mt-3"><li class="flex items-center gap-2"><span class="text-amber-600 shrink-0">💶</span><span><strong class="font-semibold text-gray-900">עלות:</strong> כ-20-30€ למנה</span></li><li class="flex items-center gap-2"><span class="text-blue-600 shrink-0">⏱️</span><span><strong class="font-semibold text-gray-900">משך מומלץ:</strong> שעתיים ומעלה - זו הפואנטה</span></li><li class="flex items-center gap-2"><span class="text-purple-600 shrink-0">✨</span><span><strong class="font-semibold text-gray-900">אווירה:</strong> כפר דייגים בערב, בלי תפריט באנגלית</span></li></ul></div>
                            <div class="premium-tip-box">
    ...
    },
    {
        ...
        dayBrief: {
            ...
            overview: `<p>זה לא יום של אתרים שצריך "לכסות" - יש בו בעצם דבר אחד גדול, השקיעה מעל צוקי לוגאס, וכל השאר מסודר סביבו. הצפון-מערב הוא הפינה הכי פחות ים-תיכונית בקורפו: צוקי חימר לבנים שנופלים ישר לים, אבן חול מפוסלת ברוח, וכפרים שנגמרים בבת אחת בקצה מצוק.</p>
                <p>שימו לב לנקודה אחת בתזמון: שעת השקיעה המדויקת ליום הזה מופיעה למעלה, ולא נצא מלוגאס לפניה. המשמעות היא שארוחת הערב היא אחריה, וההגעה חזרה למלון סביב 21:00. אם זה מאוחר מדי עבורכם, הפתרון הוא לוותר על תעלת האהבה בבוקר ולא לדחוס את השקיעה.</p>
                <p>הבוקר האיטי הזה הוא לא פשרה: להתחיל את היום בלי למהר, לא לדחוף את תעלת האהבה, ולהגיע ישר לארוחת צהריים נינוחה בפרולדס - זו בדיוק אותה תכנית, רק שבחרתם בה מההתחלה ולא כי נגמר הכוח. השקיעה בלוגאס היא העוגן היחיד של היום; כל השעות שלפניה פתוחות.</p>`,
            mustDo: [
            ...
            sunsetNote: `זו השקיעה שהיום הזה נבנה סביבה. המרפסת של 7th Heaven מעל לוגאס פונה ישר למערב - הגיעו לפחות חצי שעה מראש, ואל תתכננו כלום אחריה.`,
            highlights: [
