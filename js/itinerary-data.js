...
window.ITINERARY_DAYS = [
    ...
    },
    {
        ...
        dayArea: "מרכז קורפו",
        closingNoteHtml: `<p>😌 <strong>קחו את הזמן:</strong> אם התיישבתם לקפה מול הליסטון ונשארתם שעתיים, או שהלכתם לאיבוד בקמפיילו וויתרתם על קאנוני - זה לא פספוס. העיר הזאת מתגמלת שיטוט, לא רשימה. ולוותר על קאנוני לא חייב להיות ויתור על כלום: זו אותה נסיעה של כ-15 דקות שהביאה אתכם הבוקר, רק הפוכה - חזרה לוילה לפסק אחר צהריים אמיתי, לא כי נגמר הכוח אלא כי זה בדיוק היום לעשות את זה.</p>`,
        transitions: {
            fromHotel: null,
            between: [
