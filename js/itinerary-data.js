...
window.ITINERARY_DAYS = [
    ...
    },
    {
        ...
        dayArea: "מרכז קורפו",
        closingNoteHtml: `<p>😌 <strong>קחו את הזמן:</strong> אם התיישבתם לקפה מול הליסטון ונשארתם שעתיים, או שהלכתם לאיבוד בקמפיילו וויתרתם על קאנוני - זה לא פספוס. העיר הזאת מתגמלת שיטוט, לא רשימה. ולוותר על קאנוני לא חייב להיות ויתור על כלום: זו אותה נסיעה של כ-15 דקות שהביאה אתכם הבוקר, רק הפוכה - חזרה לוילה לפוסק אחר צהריים אמיתי, לא כי נגמר הכוח אלא כי זה בדיוק היום לעשות את זה.</p>`,
        transitions: {
            fromHotel: null,
            between: [
    ...
    },
    {
        ...
        dayBrief: {
            ...
            overview: `<p>זה לא יום של אתרים שצריך "לכסות" - יש בו בעצם דבר אחד גדול, השקיעה מעל צוקי לוגאס, וכל השאר מסודר סביבו. הצפון-מערב הוא הפינה הכי פחות ים-תיכונית בקורפו: צוקי חימר לבנים שנופלים ישר לים, אבן חול מפוסלת ברוח, וכפרים שנגמרים בבת אחת בקצה מצוק.</p>
                ...
                <p>הבוקר האיטי הזה הוא לא פשרה: לישון עד מאוחר, לא לדחוף את תעלת האהבה, ולהגיע ישר לארוחת צהריים נינוחה בפרולדס - זו בדיוק אותה תכנית, רק שבחרתם בה מההתחלה ולא כי נגמר הכוח. השקיעה בלוגאס היא העוגן היחיד של היום; כל השעות שלפניה פתוחות.</p>`,
            mustDo: [
