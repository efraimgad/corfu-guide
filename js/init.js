...
document.addEventListener("DOMContentLoaded", function() {
    ...
    initFavoriteButtons();
    initTripProgress();
    // Day cards start collapsed (accordion behavior lives in toggleDayCard,
    // js/itinerary.js) so the itinerary opens as a scannable list of 7 days
    // rather than one long scroll.
    setAllDayCards(false);
