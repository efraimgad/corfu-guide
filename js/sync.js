...
function showOfflineToastOnce() {
    ...
    // showToast() lives in js/ui.js; this file is loaded after it, but the
    // guard keeps the offline path working even if that ever changes.
    if (typeof showToast === 'function') {
        showToast('מצב לא מקוון — השינויים יישמרו כשתתחברו מחדש');
    }
}
