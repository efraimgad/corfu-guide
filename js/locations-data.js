// Source of truth for all 162 beach/food/attraction/gem entries.
//
// Originally extracted from index.html's hand-written card markup by
// scripts/extract-locations.js. That script has been REMOVED: Phase 1
// replaced the markup it parsed with empty containers + dynamic
// rendering (js/cards.js), so re-running it silently produced 0 items
// and blanked this file. This file is the source now - index.html can no
// longer regenerate it.
//
// Later transforms were applied by script rather than by hand, and that
// remains the rule for bulk edits here:
//   scripts/add-latlon.js       - lat/lon, matched by name against js/map.js
//   scripts/recolor-badges.js   - badge colors onto the Mediterranean palette
//
// Fields parking/vibe/beachType/bestTime were derived by heuristics and
// are worth spot-checking on ambiguous cards.
