// Auto-generated. Location records for the Corfu guide.
//
// Fields added by scripts/apply-verified-places.js (2026-07-30):
...
window.CORFU_LOCATIONS = {
  "beaches": [
    ...
    {
      "id": "beach-אמפלאקי-Ampelaki",
      "name": "אמפלאקי (Ampelaki)",
      "tags": "adventure,family",
      "image": {
        "src": "https://images.unsplash.com/photo-1598583424075-87515152a5c5?auto=format&fit=crop&q=80&w=800",
        "alt": "אמפלאקי (Ampelaki)"
      },
      "hasRealPhoto": false,
  ...
  "food": [
    {
      ...
      "beachType": null,
      "bestTime": "Anytime",
      "placeId": "ChIJT6jKOt1dWxMRsmc_2ery6II",
      "phone": "+302661039649",
      "verifiedHours": "11:30-23:00 (א' 17:00-23:00)",
      "address": "Kapodistriou 66, Kerkira 491 00",
      "verifiedRating": "4.5",
      "ratingCount": 2588,
    ...
    },
    {
      ...
      "beachType": null,
      "bestTime": "Anytime",
      "placeId": "ChIJ5SS-BGFCWxMRaurnkC_oFaE",
      "phone": "+302663091350",
      "verifiedHours": "13:00-22:30",
      "address": "Agni, Kerkira 490 83",
      "verifiedRating": "4.5",
      "ratingCount": 768,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">To Tavernaki tis Marinas</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> צזיקי, גירוס, סופלאקי</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">12:30 - 23:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.621%2C19.919\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט במפה</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.621%2C19.919",
      "lat": 39.621,
      "lon": 19.919,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">George &amp; Elena's Taverna</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> מוסקה ביתית, פסטיצדה, סלט קורפיוטי</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">11:00 - 23:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.624%2C19.92\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט במפה</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.624%2C19.92",
      "lat": 39.624,
      "lon": 19.92,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "beachType": null,
      "bestTime": "Anytime",
      "placeId": "ChIJsRnHQYVfWxMR5qaW5XFq4rg",
      "phone": "+306974350900",
      "verifiedHours": "17:30-22:30",
      "closedDays": [
        "SU"
      ],
      "address": "Benitses, Kerkira 490 84",
      "verifiedRating": "4.7",
      "ratingCount": 1010,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "beachType": null,
      "bestTime": "Anytime",
      "placeId": "ChIJ2TAUh3ReWxMRDz-vUO3kziQ",
      "phone": "+302661031291",
      "verifiedHours": "12:00-23:15",
      "address": "Alkiviadou Dari & Athinagora Kavvada, Kerkira 491 00",
      "verifiedRating": "4.3",
      "ratingCount": 3236,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Salto Corfu</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> כבש מבושל לאט, טליאטה, קינוח מיוחד</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">12:00 - 23:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.623%2C19.919\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט במפה</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.623%2C19.919",
      "lat": 39.623,
      "lon": 19.919,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "beachType": null,
      "bestTime": "Anytime",
      "placeId": "ChIJsdqPX29CWxMR40NPONQIOMU",
      "phone": "+302663091465",
      "verifiedHours": "12:00-23:00",
      "address": "Kalami Bay, Kerkira 490 83",
      "verifiedRating": "4.3",
      "ratingCount": 1234,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "region": "📍 גוביה / דאסיה",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Akrogiali Seafood</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 גוביה / דאסיה</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> דגי פרידה, שרימפס מקומי, אוזו</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">11:00 - 23:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.67%2C19.75\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט במפה</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.67%2C19.75",
      "lat": 39.67,
      "lon": 19.75,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "beachType": null,
      "bestTime": "Anytime",
      "placeId": "ChIJvVuXYTmfXBMR5GA0RtjghmM",
      "phone": "+302662051791",
      "verifiedHours": "12:00-22:30",
      "address": "Boukari Beach, Boukari 490 80",
      "verifiedRating": "4.3",
      "ratingCount": 1462,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "beachType": null,
      "bestTime": "Anytime",
      "placeId": "ChIJ_aZliUZPWxMRcB9STRjPzA8",
      "phone": "+302663032244",
      "verifiedHours": "18:00-23:00",
      "closedDays": [
        "TU"
      ],
      "address": "Sidari 490 81",
      "verifiedRating": "4.8",
      "ratingCount": 827,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">A Mano Corfu</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> טרטר סלמון, פסטה תוצרת בית, מולים</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">12:00 - 00:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.6235%2C19.9215\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.6235%2C19.9215",
      "lat": 39.6235,
      "lon": 19.9215,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 דרום קורפו",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Captain Octopus</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 דרום קורפו</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> זרוע תמנון, סלט ים, קלמארי ממולא</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">11:00 - 23:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.46%2C19.96\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.46%2C19.96",
      "lat": 39.46,
      "lon": 19.96,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "beachType": null,
      "bestTime": "Anytime",
      "placeId": "ChIJv06lGgxCWxMR1j53ua-PiTs",
      "phone": "+302663081521",
      "verifiedHours": "עונתי - לאמת טלפונית",
      "address": "Kerasia 49081",
      "verifiedRating": "4.1",
      "ratingCount": 466,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "beachType": null,
      "bestTime": "Anytime",
      "placeId": "ChIJYctMrJNBWxMRrU-vyi7mt6c",
      "phone": "+302663081589",
      "verifiedHours": "12:00-23:00",
      "address": "Μπαταρία Παραλία, Κασσιόπη 490 81",
      "verifiedRating": "4.5",
      "ratingCount": 594,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "beachType": null,
      "bestTime": "Anytime",
      "placeId": "ChIJpR8BzNxdWxMRuqztBRumpkE",
      "phone": "+302661030270",
      "verifiedHours": "19:30-00:00",
      "closedDays": [
        "MO",
        "SU"
      ],
      "address": "Maniarizi Arlioti 16, Kerkira 491 00",
      "verifiedRating": "4.5",
      "ratingCount": 749,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Mouragia Corfu</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> פסטיצ'יו טבעוני, פסטה עם נוף לים</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">13:00 - 23:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.626%2C19.924\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.626%2C19.924",
      "lat": 39.626,
      "lon": 19.924,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Nolita Corfu</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> בורטה, קרפצ'יו בקר, ריגטוני קרבונרה</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">12:00 - 01:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.6238%2C19.9218\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.6238%2C19.9218",
      "lat": 39.6238,
      "lon": 19.9218,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Pasta Italiana</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> פנה ארביאטה, פטוצ'יני אלפרדו</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">12:00 - 23:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.65%2C19.9\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.65%2C19.9",
      "lat": 39.65,
      "lon": 19.9,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Ninos Traditional</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> צלעות כבש, גירוס חזיר, קבב יווני</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">12:00 - 23:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.622%2C19.921\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.622%2C19.921",
      "lat": 39.622,
      "lon": 19.921,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">The Grill House</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> סטייק טי-בון, שיפודים, המבורגר</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">13:00 - 00:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.64%2C19.91\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.64%2C19.91",
      "lat": 39.64,
      "lon": 19.91,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "beachType": null,
      "bestTime": "Anytime",
      "placeId": "ChIJ3c7bbitaWxMRtlOoPDKQYjc",
      "phone": "+302661094195",
      "verifiedHours": "18:30-00:30 (א' 19:30-00:30)",
      "closedDays": [
        "TH"
      ],
      "address": "Τεμπλόνι 491 00",
      "verifiedRating": "4.7",
      "ratingCount": 1619,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Pita Pita Grill</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> סופלאקי עוף, קבב, פיתה גירוס</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">11:00 - 02:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.623%2C19.922\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.623%2C19.922",
      "lat": 39.623,
      "lon": 19.922,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "beachType": null,
      "bestTime": "Anytime",
      "placeId": "ChIJGf4Lb0ReWxMRHoKSCJYirnA",
      "phone": "+302661046191",
      "verifiedHours": "08:00-01:00",
      "address": "Kanoni Vlacherna, Kerkira 491 00",
      "verifiedRating": "4.4",
      "ratingCount": 2198,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Liston Cafe</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> קפה פראפה, קרואסון חמאה</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">08:00 - 01:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.6245%2C19.9225\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.6245%2C19.9225",
      "lat": 39.6245,
      "lon": 19.9225,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "subtitle": "Mikro Café",
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Mikro Café</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> קפה יווני, קוקטיילים, מאפים מקומיים</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">07:00 - 20:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.6238%2C19.9225\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.6238%2C19.9225",
      "lat": 39.6238,
      "lon": 19.9225,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Gabao Breakfast</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> פנקייקס, ביצי בנדיקט, שייק פירות</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">08:00 - 15:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.625%2C19.91\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.625%2C19.91",
      "lat": 39.625,
      "lon": 19.91,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "beachType": null,
      "bestTime": "Morning",
      "placeId": "ChIJC0JZpd1dWxMRakNjp9a4gD4",
      "phone": "+302661039041",
      "verifiedHours": "18:30-00:00",
      "closedDays": [
        "MO"
      ],
      "address": "Kapodistriou 4, Kerkira 491 00",
      "verifiedRating": "4.0",
      "ratingCount": 592,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Puppet Guesthouse Cafe</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> מאצ'ה, סנדוויץ' אבוקדו, מאפים</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">09:00 - 23:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.621%2C19.922\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.621%2C19.922",
      "lat": 39.621,
      "lon": 19.922,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Papagiorgis</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> גלידת קומקוואט, מילפיי, מוס</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">08:00 - 00:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.6242%2C19.9236\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.6242%2C19.9236",
      "lat": 39.6242,
      "lon": 19.9236,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Starenio Bakery</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> פאי טבעוני עטור פרסים, מאפים מסורתיים</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">06:00 - 22:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.6238%2C19.921\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.6238%2C19.921",
      "lat": 39.6238,
      "lon": 19.921,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Kukutsi Sushi Bar</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> סושי טרי, רולים יפניים-יווניים</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">10:00 - 23:30</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.599%2C19.91\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.599%2C19.91",
      "lat": 39.599,
      "lon": 19.91,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Hans &amp; Gretel</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> קיורטוש, סוכריות, וופל בלגי</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">10:00 - 00:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.625%2C19.922\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.625%2C19.922",
      "lat": 39.625,
      "lon": 19.922,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">The Cake Boutique</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> מקרונים, טארט לימון, עוגות גבינה</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">09:00 - 21:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.62%2C19.915\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.62%2C19.915",
      "lat": 39.62,
      "lon": 19.915,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "beachType": null,
      "bestTime": "Evening",
      "placeId": "ChIJeRUnh8JdWxMRU1BawiBERWM",
      "phone": "+302661100340",
      "verifiedHours": "10:00-02:00",
      "address": "Faliraki beach, Κέρκυρα 491 00",
      "verifiedRating": "4.3",
      "ratingCount": 2647,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "beachType": null,
      "bestTime": "Evening",
      "placeId": "ChIJ27MUbP9YWxMRi0rMq9iobjw",
      "phone": "+302661094444",
      "verifiedHours": "10:00-19:00",
      "address": "Γλυφάδα 491 00",
      "verifiedRating": "3.6",
      "ratingCount": 2150,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Skyview All Day Place</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold mb-3 badge-gold-bg badge-gold-text\">🍷 בר/לאונג'</span><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold mb-3 badge-gold-bg badge-gold-text\">🌙 חוויה למבוגרים</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> קוקטיילים, נשנושים, נוף פנורמי</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">09:00 - 03:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.6%2C19.905\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.6%2C19.905",
      "lat": 39.6,
      "lon": 19.905,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "beachType": null,
      "bestTime": "Evening",
      "placeId": "ChIJ4_H-5t1dWxMRaHHlQY3UmU0",
      "verifiedHours": "09:00-03:00",
      "address": "Leof. Dimokratias 1, Kerkira 491 00",
      "verifiedRating": "4.2",
      "ratingCount": 2377,
      "phoneNote": "Google lists no phone - book via their socials or in person",
      "verifiedOn": "2026-07-30"
    },
    {
      "id": "food-ברבטי-קלאב",
      ...
      "region": "📍 צפון קורפו",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Barbati Club</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 צפון קורפו</span><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold mb-3 badge-gold-bg badge-gold-text\">🍷 בר/לאונג'</span><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold mb-3 badge-gold-bg badge-gold-text\">🌙 חוויה למבוגרים</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> קוקטייל פירות, אבטיח, צ'יפס</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">10:00 - 00:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.71%2C19.87\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.71%2C19.87",
      "lat": 39.71,
      "lon": 19.87,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Dionysos Corfu</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> גירוס, סובלאקי, פיתה טרייה</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">11:00 - 02:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.624%2C19.921\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.624%2C19.921",
      "lat": 39.624,
      "lon": 19.921,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Soul Souvlaki</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> סופלאקי פרגיות, חלומי</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">12:00 - 00:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.622%2C19.91\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.622%2C19.91",
      "lat": 39.622,
      "lon": 19.91,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Bougainvillea Corfu</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> מנות יווניות מסורתיות, סלטים טריים</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">12:00 - 23:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.598%2C19.909\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.598%2C19.909",
      "lat": 39.598,
      "lon": 19.909,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "subtitle": "Burger Bar",
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Burger Bar</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> צ'יזבורגר, טבעות בצל</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">13:00 - 01:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.63%2C19.92\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.63%2C19.92",
      "lat": 39.63,
      "lon": 19.92,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "subtitle": "Pizzeta",
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-4 font-mono\">Pizzeta</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><div class=\"space-y-3 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> משולש פיצה, פוקאצ'ה</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">11:00 - 00:00</span></p>\n                        <div class=\"flex items-center gap-2 mt-2\"><span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אין חובת הזמנה</span></div>\n                    </div><div class=\"mt-6 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.621%2C19.911\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.621%2C19.911",
      "lat": 39.621,
      "lon": 19.911,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "beachType": null,
      "bestTime": "Anytime",
      "placeId": "ChIJFd5zO8NdWxMRlc_nhVt9CcA",
      "phone": "+302661550955",
      "verifiedHours": "18:30-23:30 (ה'-ש' 19:00-23:30)",
      "closedDays": [
        "SU"
      ],
      "address": "Πλατεία Λίλη Δεσύλλα 1, Κέρκυρα 491 00",
      "verifiedRating": "4.5",
      "ratingCount": 851,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "beachType": null,
      "bestTime": "Anytime",
      "placeId": "ChIJHZ8YIN1dWxMRKsU-6w6RivY",
      "phone": "+306988856622",
      "verifiedHours": "19:30-23:30",
      "closedDays": [
        "MO"
      ],
      "address": "Kato Korakiana 490 83",
      "verifiedRating": "4.6",
      "ratingCount": 451,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "beachType": null,
      "bestTime": "Anytime",
      "placeId": "ChIJ1-dAyLRdWxMRyBFDeuVafHo",
      "phone": "+302661030110",
      "verifiedHours": "07:00-00:00",
      "address": "Kapodistriou 44, Kerkira 491 31",
      "verifiedRating": "4.6",
      "ratingCount": 378,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "beachType": null,
      "bestTime": "Anytime",
      "placeId": "ChIJm1sGkdxdWxMR14OXkzxRqzI",
      "phone": "+302661028680",
      "verifiedHours": "18:30-23:30",
      "address": "Skaramagka 13, Kerkira 491 00",
      "verifiedRating": "4.5",
      "ratingCount": 683,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "beachType": null,
      "bestTime": "Anytime",
      "placeId": "ChIJ5xGcNy5dWxMR5n1Oeq9i9lE",
      "phone": "+302661041300",
      "verifiedHours": "19:00-01:00",
      "address": "Agoniston Politechniou, Kerkira 491 00",
      "verifiedRating": "4.1",
      "ratingCount": 428,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "beachType": null,
      "bestTime": "Anytime",
      "placeId": "ChIJz8roCp1dWxMRRQ1bM-JzcoE",
      "phone": "+302661044718",
      "verifiedHours": "12:00-23:30",
      "address": "Gkilford 69, Kerkira 491 00",
      "verifiedRating": "4.6",
      "ratingCount": 878,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "beachType": null,
      "bestTime": "Sunset",
      "placeId": "ChIJVeWe44JOWxMR9w5X4xyMDJ4",
      "phone": "+302663095035",
      "verifiedHours": "11:00-00:00",
      "address": "Peroulades 490 81",
      "verifiedRating": "4.6",
      "ratingCount": 4395,
      "verifiedOn": "2026-07-30"
    },
    ...
    },
    {
      ...
      "beachType": null,
      "bestTime": "Sunset",
      "placeId": "ChIJaXp30dxdWxMRF2qRvfGbh_I",
      "phone": "+306932158888",
      "verifiedHours": "19:00-22:00",
      "closedDays": [
        "MO",
        "SA",
        "SU"
      ],
      "address": "Επαρχιακή Πέλεκα, Καρουμπάτικα, Kerkira 491 00",
      "verifiedRating": "4.3",
      "ratingCount": 1023,
      "verifiedOn": "2026-07-30"
    },
    {
      ...
      "region": "📍 מרכז-מערב",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-2 font-mono\">Chris Place / Sofia's, Pentati</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 מרכז-מערב</span><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold mb-3 badge-gold-bg badge-gold-text\">🌙 חוויה למבוגרים</span><p class=\"text-sm text-gray-600 mb-3\">טברנה כפרית מוסתרת בכפר ההררי פנטטי שבמערב האי. סופיה מבשלת הכל בעצמה. נוף עוצר נשימה למפרץ אגיוס גורדיוס ושקיעה בלתי נשכחת.</p><div class=\"space-y-2.5 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> מוסקה ביתית, צלעות כבש, סגנאקי, יין הבית</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">17:00 - 23:00</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">💶</span><span>ממוצע לזוג: €25–40 (זול מאוד!)</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🅿️</span><span>חניה ברחוב הכפר, בחינם</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-red-500\">🚗</span><span>כביש הגעה: עלייה תלולה ומפותלת לכפר ההררי פנטטי, לא מומלץ בחושך או בגשם</span></p>\n                        <div class=\"flex flex-wrap gap-1.5 mt-2\">\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">ללא הזמנה</span>\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-gold-bg badge-gold-text\">💎 פנינה נסתרת</span>\n                        </div>\n                        <div class=\"bg-gray-50 rounded-lg p-2.5 mt-2 space-y-1 text-xs\">\n                            <p><span class=\"text-green-600 font-bold\">✅</span> <strong>יתרונות:</strong> הכי אותנטי שיש, מחירים מגוחכים, אוכל ביתי ברמה גבוהה, שקיעה פנומנלית</p>\n                            <p><span class=\"text-red-500 font-bold\">❌</span> <strong>חסרונות:</strong> כביש הגעה תלול, תפריט מצומצם (מה שסופיה בישלה היום), מבודד</p>\n                            <p><span class=\"text-blue-500 font-bold\">🎯</span> <strong>מתאים ל:</strong> מטיילים שמחפשים חוויה יוונית אמיתית, זוגות הרפתקניים</p>\n                        </div>\n                    </div><div class=\"mt-4 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.539%2C19.835\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט במפה</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.539%2C19.835",
      "lat": 39.539,
      "lon": 19.835,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 פלאוקסטריצה / צפון-מערב",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-2 font-mono\">Akron Beach Bar, Paleokastritsa</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 פלאוקסטריצה / צפון-מערב</span><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold mb-3 badge-ion-bg badge-ion-text\">🌊 על החוף</span><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold mb-3 badge-gold-bg badge-gold-text\">🌙 חוויה למבוגרים</span><p class=\"text-sm text-gray-600 mb-3\">בר-מסעדה מעוצב על חוף אגיה טריאדה, עם מיטות שיזוף יוקרתיות, קוקטיילים מושקעים ואוכל ים תיכוני.</p><div class=\"space-y-2.5 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> סלט קורפיוטי, שרימפס על הגריל, Aperol Spritz</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">10:00 - 01:00</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">💶</span><span>קוקטייל: €10–14 | מנה: €12–22</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🅿️</span><span>חניה בתשלום בפלאוקסטריצה, 5 דק' הליכה</span></p>\n                        <div class=\"flex flex-wrap gap-1.5 mt-2\">\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">ללא הזמנה</span>\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-gold-bg badge-gold-text\">מוזיקה חיה בקיץ</span>\n                        </div>\n                        <div class=\"bg-gray-50 rounded-lg p-2.5 mt-2 space-y-1 text-xs\">\n                            <p><span class=\"text-green-600 font-bold\">✅</span> <strong>יתרונות:</strong> עיצוב מרשים, נוף לים, אווירה נעימה אחר הצהריים</p>\n                            <p><span class=\"text-red-500 font-bold\">❌</span> <strong>חסרונות:</strong> מיטות שיזוף בתשלום (€15+), מחירי קוקטיילים גבוהים</p>\n                            <p><span class=\"text-blue-500 font-bold\">🎯</span> <strong>מתאים ל:</strong> זוגות צעירים, יום חוף + שתייה, אינסטגרם</p>\n                        </div>\n                    </div><div class=\"mt-4 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.673348%2C19.715083\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט במפה</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.673348%2C19.715083",
      "lat": 39.673348,
      "lon": 19.715083,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 מרכז-מערב",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-2 font-mono\">Nagual Beach Bar, Kontogialos</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 מרכז-מערב</span><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold mb-3 badge-ion-bg badge-ion-text\">🌊 על החוף</span><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold mb-3 badge-gold-bg badge-gold-text\">🌙 חוויה למבוגרים</span><p class=\"text-sm text-gray-600 mb-3\">ביץ' בר אנרגטי על חוף קונטוגיאלוס (פלקאס) עם מסיבות, מוזיקה ואווירת קיץ יוונית. החוף עצמו מהיפים במערב האי.</p><div class=\"space-y-2.5 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> בורגרים, נאצ'וס, מוחיטו, שייקרטו</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">10:00 - 02:00</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">💶</span><span>קוקטייל: €9–12 | מנה: €10–18</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🅿️</span><span>חניה חינם מעל החוף (ירידה רגלית)</span></p>\n                        <div class=\"flex flex-wrap gap-1.5 mt-2\">\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">ללא הזמנה</span>\n                        </div>\n                        <div class=\"bg-gray-50 rounded-lg p-2.5 mt-2 space-y-1 text-xs\">\n                            <p><span class=\"text-green-600 font-bold\">✅</span> <strong>יתרונות:</strong> חוף חולי יפה, אווירת מסיבה, מחירים סבירים</p>\n                            <p><span class=\"text-red-500 font-bold\">❌</span> <strong>חסרונות:</strong> רועש (לא מתאים למחפשי שקט), ירידה תלולה לחוף</p>\n                            <p><span class=\"text-blue-500 font-bold\">🎯</span> <strong>מתאים ל:</strong> צעירים, חברות, מסיבת חוף ביום</p>\n                        </div>\n                    </div><div class=\"mt-4 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.5904%2C19.8169\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט במפה</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.5904%2C19.8169",
      "lat": 39.5904,
      "lon": 19.8169,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 דרום קורפו",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-2 font-mono\">Sirens Lounge, Marathias Beach</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 דרום קורפו</span><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold mb-3 badge-ion-bg badge-ion-text\">🌊 על החוף</span><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold mb-3 badge-gold-bg badge-gold-text\">🌙 חוויה למבוגרים</span><p class=\"text-sm text-gray-600 mb-3\">ביץ' בר רגוע עם ערסלים על חוף מרתיאס בדרום. אווירה שקטה ונינוחה, מתאים לזוגות שרוצים יום חוף בלי המולה.</p><div class=\"space-y-2.5 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> סלטים טריים, פיתות, סמוזי פירות, מרגריטה</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">10:00 - שקיעה</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">💶</span><span>קוקטייל: €8–11 | מנה: €8–15</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🅿️</span><span>חניה חינם על הדרך ליד החוף</span></p>\n                        <div class=\"flex flex-wrap gap-1.5 mt-2\">\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">ללא הזמנה</span>\n                        </div>\n                        <div class=\"bg-gray-50 rounded-lg p-2.5 mt-2 space-y-1 text-xs\">\n                            <p><span class=\"text-green-600 font-bold\">✅</span> <strong>יתרונות:</strong> חוף שקט ויפהפה, ערסלים חינם, אווירה בוהמיינית רגועה</p>\n                            <p><span class=\"text-red-500 font-bold\">❌</span> <strong>חסרונות:</strong> רחוק מהעיר (30 דק' נסיעה), סוגר מוקדם, תפריט מצומצם</p>\n                            <p><span class=\"text-blue-500 font-bold\">🎯</span> <strong>מתאים ל:</strong> זוגות, מחפשי שלווה, יום ניתוק מהעולם</p>\n                        </div>\n                    </div><div class=\"mt-4 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.418%2C20.0035\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט במפה</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.418%2C20.0035",
      "lat": 39.418,
      "lon": 20.0035,
      "parking": "Unknown",
    ...
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-2 font-mono\">Elia Taverna, Corfu Town</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold mb-3 badge-ion-bg badge-ion-text\">👶 תפריט ילדים</span><p class=\"text-sm text-gray-600 mb-3\">טברנה מקומית אותנטית בלב העיר העתיקה שמקומיים ותיירים אוהבים. ישיבה בחצר סמטה ירוקה ונעימה.</p><div class=\"space-y-2.5 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> סטיפאדו, סופריטו, בשר על הגריל, פאי ספינאך</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">12:00 - 23:30</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">💶</span><span>ממוצע לזוג: €25–40</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🅿️</span><span>אין (העיר העתיקה להולכי רגל). חניה עירונית ב-5 דק'</span></p>\n                        <div class=\"flex flex-wrap gap-1.5 mt-2\">\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">ללא הזמנה (מומלץ בקיץ)</span>\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-ion-bg badge-ion-text\">👶 ידידותי לילדים</span>\n                        </div>\n                        <div class=\"bg-gray-50 rounded-lg p-2.5 mt-2 space-y-1 text-xs\">\n                            <p><span class=\"text-green-600 font-bold\">✅</span> <strong>יתרונות:</strong> אוכל ביתי מצוין, מנות גדולות, מחירים זולים, אווירה מקומית</p>\n                            <p><span class=\"text-red-500 font-bold\">❌</span> <strong>חסרונות:</strong> מקום קטן - ייתכן המתנה, ללא חניה בסביבה</p>\n                            <p><span class=\"text-blue-500 font-bold\">🎯</span> <strong>מתאים ל:</strong> משפחות, תיירים שרוצים לאכול כמו מקומיים, תקציב נמוך</p>\n                        </div>\n                    </div><div class=\"mt-4 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.6245%2C19.9218\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט במפה</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.6245%2C19.9218",
      "lat": 39.6245,
      "lon": 19.9218,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-2 font-mono\">Pane e Souvlaki, Corfu Town</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold mb-3 badge-ion-bg badge-ion-text\">👶 תפריט ילדים</span><p class=\"text-sm text-gray-600 mb-3\">שילוב מנצח של סובלאקי יווני עם לחם איטלקי טרי. ארוחה מהירה, טעימה ומשביעה בלב העיר העתיקה.</p><div class=\"space-y-2.5 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> סובלאקי חזיר, גירוס עוף, צ'יפס ביתי, סלט יווני</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">11:00 - 23:00</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">💶</span><span>ממוצע לאדם: €7–12</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🅿️</span><span>אין (העיר העתיקה)</span></p>\n                        <div class=\"flex flex-wrap gap-1.5 mt-2\">\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">ללא הזמנה</span>\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-ion-bg badge-ion-text\">👶 ידידותי לילדים</span>\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-gold-bg badge-gold-text\">🥡 טייק אווי</span>\n                        </div>\n                        <div class=\"bg-gray-50 rounded-lg p-2.5 mt-2 space-y-1 text-xs\">\n                            <p><span class=\"text-green-600 font-bold\">✅</span> <strong>יתרונות:</strong> מהיר, טעים, זול, מיקום מרכזי, מנות גדולות</p>\n                            <p><span class=\"text-red-500 font-bold\">❌</span> <strong>חסרונות:</strong> עמוס מאוד בשעות שיא, ישיבה מצומצמת</p>\n                            <p><span class=\"text-blue-500 font-bold\">🎯</span> <strong>מתאים ל:</strong> משפחות עם ילדים, ארוחה מהירה בין סיורים, תקציב נמוך</p>\n                        </div>\n                    </div><div class=\"mt-4 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.6261%2C19.9206\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט במפה</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.6261%2C19.9206",
      "lat": 39.6261,
      "lon": 19.9206,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 קורפו טאון",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-2 font-mono\">Aubergine Café, Corfu Town</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 קורפו טאון</span><p class=\"text-sm text-gray-600 mb-3\">מסעדה צמחונית עם תפריט טבעוני נרחב, ממוקמת בכיכר פופולרית ליד הארמון. מוסקה טבעונית שגם אוכלי בשר אוהבים.</p><div class=\"space-y-2.5 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> מוסקה טבעונית, גירוס טבעוני, סלט עם חלומי, פאלאפל</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span dir=\"ltr\">10:00 - 23:00</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">💶</span><span>ממוצע לאדם: €10–18</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🅿️</span><span>אין (העיר העתיקה)</span></p>\n                        <div class=\"flex flex-wrap gap-1.5 mt-2\">\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">ללא הזמנה</span>\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">🥬 צמחוני + טבעוני</span>\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-gold-bg badge-gold-text\">GF אפשרויות ללא גלוטן</span>\n                        </div>\n                        <div class=\"bg-gray-50 rounded-lg p-2.5 mt-2 space-y-1 text-xs\">\n                            <p><span class=\"text-green-600 font-bold\">✅</span> <strong>יתרונות:</strong> פתוח גם לארוחת ערב (בניגוד לביזו), מיקום מרכזי, תפריט מגוון</p>\n                            <p><span class=\"text-red-500 font-bold\">❌</span> <strong>חסרונות:</strong> מנות קטנות יחסית למחיר, ישיבה בכיכר עמוסה</p>\n                            <p><span class=\"text-blue-500 font-bold\">🎯</span> <strong>מתאים ל:</strong> ארוחת ערב צמחונית/טבעונית, קבוצות מעורבות (יש גם לא-טבעוני)</p>\n                        </div>\n                    </div><div class=\"mt-4 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.6234%2C19.9228\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט במפה</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.6234%2C19.9228",
      "lat": 39.6234,
      "lon": 19.9228,
      "parking": "Unknown",
      "vibe": [
    ...
    {
      "id": "food-טברנת-אגני-Taverna-Agni",
      "category": "cat-fish",
      "tags": "fish,upscale",
      "image": {
        "src": "https://images.pexels.com/photos/1450353/pexels-photo-1450353.jpeg?auto=compress&cs=tinysrgb&w=600",
      ...
      "region": "📍 צפון קורפו",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-2 font-mono\">Taverna Agni, Agni Bay</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 צפון קורפו</span><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold mb-3 badge-ion-bg badge-ion-text\">🌊 על החוף</span><p class=\"text-sm text-gray-600 mb-3\">אחת משלוש הטברנות הוותיקות היושבות ממש על קו המים במפרץ אגני, לצד Toula's Gastronomy וניקולס. מתמחה בדגים ופירות ים טריים. המדריך ממליץ להזמין מקום מראש, במיוחד בעונת השיא.</p><div class=\"space-y-2.5 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> דגים טריים לפי משקל, פירות ים</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span>לא אומת - מומלץ להתקשר ולבדוק לפני ההגעה</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">💶</span><span>לא אומת - טווח משוער בהתאם לשאר טברנות המפרץ (יוקרתי)</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🅿️</span><span>חניה מוגבלת לאורך הכביש היורד למפרץ</span></p>\n                        <div class=\"flex flex-wrap gap-1.5 mt-2\">\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-gold-bg badge-gold-text\">מומלץ להזמין מראש</span>\n                        </div>\n                        <div class=\"bg-gray-50 rounded-lg p-2.5 mt-2 space-y-1 text-xs\">\n                            <p><span class=\"text-green-600 font-bold\">✅</span> <strong>יתרונות:</strong> ישיבה על קו המים, אחת משלוש הטברנות המסורתיות של המפרץ</p>\n                            <p><span class=\"text-red-500 font-bold\">❌</span> <strong>חסרונות:</strong> מחירים גבוהים, עלול להיות עמוס בשיא העונה</p>\n                            <p><span class=\"text-blue-500 font-bold\">🎯</span> <strong>מתאים ל:</strong> ארוחת צהריים יוקרתית באגני, אוהבי דגים</p>\n                        </div>\n                    </div><div class=\"mt-4 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.736%2C19.929\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט במפה</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.736%2C19.929",
      "lat": 39.736,
      "lon": 19.929,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 צפון קורפו",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-2 font-mono\">Ognistra, Old Perithia</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 צפון קורפו</span><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold mb-3 badge-gold-bg badge-gold-text\">🏚️ כפר נטוש</span><p class=\"text-sm text-gray-600 mb-3\">אחת הטברנות הפועלות בכפר הרפאים פלאיה פריתיה, על מורדות הר פנטוקרטור. מוכרת בעיקר לסועדים מקומיים בסופי שבוע, ומתמחה במאכלים מנחמים כמו פשטידות מקומיות (Pita) ובשרים בבישול ארוך על האש.</p><div class=\"space-y-2.5 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> פיתות מקומיות, בשר בבישול ארוך, פסטיצדה</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span>לא אומת - כפר נידח, מומלץ לוודא שהמקום פתוח לפני הנסיעה</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">💶</span><span>לא אומת - המדריך מציין טווח כללי של כ-15-20€ למנה לאזור</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🅿️</span><span>חניה חופשית בכיכר הכפר</span></p>\n                        <div class=\"flex flex-wrap gap-1.5 mt-2\">\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אווירה כפרית</span>\n                        </div>\n                        <div class=\"bg-gray-50 rounded-lg p-2.5 mt-2 space-y-1 text-xs\">\n                            <p><span class=\"text-green-600 font-bold\">✅</span> <strong>יתרונות:</strong> אוכל מנחם ואותנטי, אחת משתי הטברנות המומלצות לסעודת הפרידה בפריתיה</p>\n                            <p><span class=\"text-red-500 font-bold\">❌</span> <strong>חסרונות:</strong> כביש גישה הררי וצר, לא תמיד פתוח באמצע השבוע</p>\n                            <p><span class=\"text-blue-500 font-bold\">🎯</span> <strong>מתאים ל:</strong> סיום מסלול הפנטוקרטור, אוהבי אוכל כפרי מסורתי</p>\n                        </div>\n                    </div><div class=\"mt-4 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.73%2C19.85\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט במפה</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.73%2C19.85",
      "lat": 39.73,
      "lon": 19.85,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 צפון קורפו",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-2 font-mono\">Foros, Old Perithia</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 צפון קורפו</span><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold mb-3 badge-gold-bg badge-gold-text\">🏚️ כפר נטוש</span><p class=\"text-sm text-gray-600 mb-3\">הטברנה השנייה המומלצת בפלאיה פריתיה, ידועה בזכות תבשיל ה\"פסטיצדה\" העשיר שמתבשל שעות על אש קטנה. יושבת בכיכר הכפר לצד בתי האבן הוונציאניים ההרוסים.</p><div class=\"space-y-2.5 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> פסטיצדה, מנות בשר מתבשלות לאט</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span>לא אומת - כפר נידח, מומלץ לוודא שהמקום פתוח לפני הנסיעה</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">💶</span><span>לא אומת - המדריך מציין טווח כללי של כ-15-20€ למנה לאזור</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🅿️</span><span>חניה חופשית בכיכר הכפר</span></p>\n                        <div class=\"flex flex-wrap gap-1.5 mt-2\">\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">אווירה כפרית</span>\n                        </div>\n                        <div class=\"bg-gray-50 rounded-lg p-2.5 mt-2 space-y-1 text-xs\">\n                            <p><span class=\"text-green-600 font-bold\">✅</span> <strong>יתרונות:</strong> פסטיצדה מתבשלת שעות, אחת משתי הטברנות המומלצות לסעודת הפרידה בפריתיה</p>\n                            <p><span class=\"text-red-500 font-bold\">❌</span> <strong>חסרונות:</strong> כביש גישה הררי וצר, לא תמיד פתוח באמצע השבוע</p>\n                            <p><span class=\"text-blue-500 font-bold\">🎯</span> <strong>מתאים ל:</strong> סיום מסלול הפנטוקרטור, אוהבי אוכל כפרי מסורתי</p>\n                        </div>\n                    </div><div class=\"mt-4 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.729%2C19.851\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט במפה</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.729%2C19.851",
      "lat": 39.729,
      "lon": 19.851,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 פלאוקסטריצה / צפון-מערב",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-2 font-mono\">Bella Vista, Lakones</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 פלאוקסטריצה / צפון-מערב</span><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold mb-3 badge-ion-bg badge-ion-text\">🌅 תצפית פנורמית</span><p class=\"text-sm text-gray-600 mb-3\">בית קפה-מסעדה בכפר לאקונס, עם מרפסת/חלון זכוכית המשקיפה על מפרצי פלאוקסטריצה מלמעלה. אפשרות מצוינת ליום גשום או לעצירת קפה/ארוחה עם הנוף הדרמטי ביותר באזור, לפי המדריך.</p><div class=\"space-y-2.5 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> קפה, ארוחה קלה עם נוף</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span>לא אומת - מומלץ לבדוק לפני ההגעה</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">💶</span><span>לא אומת - מומלץ לבדוק לפני ההגעה</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🅿️</span><span>חניה מוגבלת בכביש הראשי של לאקונס</span></p>\n                        <div class=\"flex flex-wrap gap-1.5 mt-2\">\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-gold-bg badge-gold-text\">☂️ מקורה - אופציה טובה לגשם</span>\n                        </div>\n                        <div class=\"bg-gray-50 rounded-lg p-2.5 mt-2 space-y-1 text-xs\">\n                            <p><span class=\"text-green-600 font-bold\">✅</span> <strong>יתרונות:</strong> נוף פנורמי למפרצי פלאוקסטריצה, מרפסת זכוכית מוגנת מגשם</p>\n                            <p><span class=\"text-red-500 font-bold\">❌</span> <strong>חסרונות:</strong> מחירי תיירים כמו בשאר לאקונס, עלול להיות עמוס בשעות השקיעה</p>\n                            <p><span class=\"text-blue-500 font-bold\">🎯</span> <strong>מתאים ל:</strong> יום גשום, עצירת נוף בדרך למבצר אנגלוקסטרו</p>\n                        </div>\n                    </div><div class=\"mt-4 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.685%2C19.71\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט במפה</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.685%2C19.71",
      "lat": 39.685,
      "lon": 19.71,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 פלאוקסטריצה / צפון-מערב",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-2 font-mono\">Golden Fox, Makrades ridge road</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 פלאוקסטריצה / צפון-מערב</span><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold mb-3 badge-ion-bg badge-ion-text\">🌅 תצפית פנורמית</span><p class=\"text-sm text-gray-600 mb-3\">מסעדה על רכס ההרים בין לאקונס למקרדס, מוכרת בזכות המרפסת הפתוחה עם אחת התצפיות הפנורמיות המרשימות על מפרצי פלאוקסטריצה וקו החוף המערבי. עצירה פופולרית בטיולים מאורגנים לאזור.</p><div class=\"space-y-2.5 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> מנות יווניות מסורתיות, נוף שקיעה</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span>לא אומת - מומלץ לבדוק לפני ההגעה</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">💶</span><span>לא אומת - מומלץ לבדוק לפני ההגעה</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🅿️</span><span>חניה זמינה לצד הכביש</span></p>\n                        <div class=\"flex flex-wrap gap-1.5 mt-2\">\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-gold-bg badge-gold-text\">עצירה פופולרית בטיולים מאורגנים</span>\n                        </div>\n                        <div class=\"bg-gray-50 rounded-lg p-2.5 mt-2 space-y-1 text-xs\">\n                            <p><span class=\"text-green-600 font-bold\">✅</span> <strong>יתרונות:</strong> נוף פנורמי יוצא דופן, מרפסת גדולה</p>\n                            <p><span class=\"text-red-500 font-bold\">❌</span> <strong>חסרונות:</strong> עמוס בשעות השקיעה עם קבוצות מאורגנות, מחירי תיירים</p>\n                            <p><span class=\"text-blue-500 font-bold\">🎯</span> <strong>מתאים ל:</strong> שקיעה עם ארוחה, טיול ברכס לאקונס-מקרדס</p>\n                        </div>\n                    </div><div class=\"mt-4 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.694%2C19.7\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט במפה</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.694%2C19.7",
      "lat": 39.694,
      "lon": 19.7,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "region": "📍 פלאוקסטריצה / צפון-מערב",
      "restHtml": "<p class=\"text-sm text-gray-500 mb-2 font-mono\">Vrachos Taverna, Paleokastritsa harbour</p><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-semibold mb-2 badge-sand-bg badge-sand-text\">📍 פלאוקסטריצה / צפון-מערב</span><span class=\"inline-flex items-center gap-1 px-2 py-1 rounded-md text-xs font-bold mb-3 badge-ion-bg badge-ion-text\">🌊 על החוף</span><p class=\"text-sm text-gray-600 mb-3\">טברנת דגים ופירות ים ליד הנמל הקטן של פלאוקסטריצה, במרחק הליכה מהמנזר וממפרצי החוף המרכזי. אופציה נוחה לארוחה לפני או אחרי שייט מאמפלאקי/אליפא הסמוכים.</p><div class=\"space-y-2.5 flex-1 text-sm text-gray-700\">\n                        <p class=\"flex items-start gap-2 bg-gray-50 p-2 rounded-lg\"><span class=\"text-blue-500 mt-0.5\">🍳</span><span><strong class=\"font-semibold text-gray-900\">מומלץ:</strong> דגים טריים, פירות ים, סלט יווני</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🕒</span><span>לא אומת - מומלץ לבדוק לפני ההגעה</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">💶</span><span>לא אומת - מומלץ לבדוק לפני ההגעה</span></p>\n                        <p class=\"flex items-center gap-2\"><span class=\"text-blue-500\">🅿️</span><span>חניון ציבורי בתשלום בפלאוקסטריצה</span></p>\n                        <div class=\"flex flex-wrap gap-1.5 mt-2\">\n                            <span class=\"px-2 py-1 text-xs font-bold rounded-full badge-olive-bg badge-olive-text\">קרוב לנמל ולנקודות היציאה לשיט</span>\n                        </div>\n                        <div class=\"bg-gray-50 rounded-lg p-2.5 mt-2 space-y-1 text-xs\">\n                            <p><span class=\"text-green-600 font-bold\">✅</span> <strong>יתרונות:</strong> מיקום נוח ליד הנמל, קרוב לחוף המרכזי ולמנזר</p>\n                            <p><span class=\"text-red-500 font-bold\">❌</span> <strong>חסרונות:</strong> עמוס בשיא היום התיירותי, מחירי אזור תיירותי מרכזי</p>\n                            <p><span class=\"text-blue-500 font-bold\">🎯</span> <strong>מתאים ל:</strong> ארוחה לפני/אחרי שייט, משפחות</p>\n                        </div>\n                    </div><div class=\"mt-4 pt-4 border-t border-gray-100 flex items-center justify-between gap-3\">\n                        <a href=\"https://www.google.com/maps/search/?api=1&query=39.671%2C19.703\" class=\"flex-1 text-center hover:bg-blue-100 py-2 rounded-xl font-semibold transition-colors text-sm flex items-center justify-center gap-2 badge-ion-bg badge-ion-text\">📍 ניווט במפה</a>\n                    </div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.671%2C19.703",
      "lat": 39.671,
      "lon": 19.703,
      "parking": "Unknown",
      "vibe": [
  ...
  "attractions": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.5628042%2C19.9042949&query_place_id=ChIJmw5o8qBfWxMRm4buTPgPS_k",
      "lat": 39.5628042,
      "lon": 19.9042949,
      "parking": "Unknown",
      "vibe": [
      ...
      "beachType": null,
      "bestTime": "Afternoon",
      "placeId": "ChIJmw5o8qBfWxMRm4buTPgPS_k",
      "phone": "+302661056210",
      "verifiedHours": "08:00-20:00",
      "verifiedOn": "2026-07-30",
      "priceFlag": "Guide says 12€. Recent visitor reviews mention 7€ and note the palace INTERIOR was closed for renovation. Verify price + whether the interior has reopened before Day 5."
    },
    {
      "id": "attr-3",
      "tags": "history",
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.6695032%2C19.7015685&query_place_id=ChIJvyQxYiNRWxMROSB3OkWyCBA",
      "lat": 39.6695032,
      "lon": 19.7015685,
      "parking": "Unknown",
      "vibe": [
      ...
      "beachType": null,
      "bestTime": "Early Morning",
      "placeId": "ChIJvyQxYiNRWxMROSB3OkWyCBA",
      "phone": "+302662041210",
      "verifiedHours": "06:30-13:00, 15:00-19:00",
      "verifiedOn": "2026-07-30",
      "verifyNote": "Guide says 15:00-20:00 for the afternoon slot; Google says 15:00-19:00."
    },
    {
      "id": "attr-4",
      "tags": "nature",
      ...
      "hasRealPhoto": false,
      "score": "ציון: 8.5",
      "title": "תעלת האהבה (Canal d'Amour) ❤️",
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.6782141%2C19.6865652&query_place_id=ChIJWUz9xmpRWxMR4f_taueTDQY",
      "lat": 39.6782141,
      "lon": 19.6865652,
      "parking": "Unknown",
      "vibe": [
      ...
      "beachType": null,
      "bestTime": "Afternoon",
      "placeId": "ChIJWUz9xmpRWxMR4f_taueTDQY",
      "verifiedHours": "10:00-17:30",
      "closedDays": [
        "TU"
      ],
      "verifiedOn": "2026-07-30",
      "priceFlag": "Guide says 3€. A recent review mentions 10€. Verify.",
      "verifyNote": "Guide's Tuesday closure is CORRECT. Guide hours 10:00-18:00 vs Google 10:00-17:30."
    },
    {
      "id": "attr-6",
      "tags": "nature",
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.7469444%2C19.8711111&query_place_id=ChIJRwxNOZxDWxMRDtfG5FsqoF8",
      "lat": 39.7469444,
      "lon": 19.8711111,
      "parking": "Unknown",
      "vibe": [
      ...
      "beachType": null,
      "bestTime": "Morning",
      "placeId": "ChIJRwxNOZxDWxMRDtfG5FsqoF8",
      "verifiedHours": "24/7",
      "verifiedOn": "2026-07-30",
      "verifyNote": "Summit cafe/monastery reported closed on some Sundays."
    },
    {
      "id": "attr-7",
      "tags": "beach",
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.5899918%2C19.9171444&query_place_id=ChIJOSSxWEReWxMRbGerY3mwsw4",
      "lat": 39.5899918,
      "lon": 19.9171444,
      "parking": "Unknown",
      "vibe": [
      ...
      "beachType": null,
      "bestTime": "Sunset",
      "placeId": "ChIJOSSxWEReWxMRbGerY3mwsw4",
      "verifiedHours": "08:00-23:00",
      "verifiedOn": "2026-07-30"
    },
    {
      "id": "attr-10",
      ...
      "hasRealPhoto": false,
      "score": "ציון: 8.9",
      "title": "המבצר הישן (Palaio Frourio) 🏰",
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.6234796%2C19.9274977&query_place_id=ChIJc8Bxy-ddWxMRhASx_pNTDTU",
      "lat": 39.6234796,
      "lon": 19.9274977,
      "parking": "Unknown",
      "vibe": [
      ...
      "beachType": null,
      "bestTime": "Morning",
      "placeId": "ChIJc8Bxy-ddWxMRhASx_pNTDTU",
      "phone": "+302661048120",
      "verifiedHours": "08:00-20:00",
      "verifiedOn": "2026-07-30",
      "priceFlag": "Guide says 6€. A recent review mentions 10€. Verify."
    },
    {
      "id": "attr-11",
      "tags": "history",
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.7986294%2C19.6738109&query_place_id=ChIJ16bUkbVPWxMRqYxyX32_PzM",
      "lat": 39.7986294,
      "lon": 19.6738109,
      "parking": "Unknown",
      "vibe": [
      ...
      "beachType": null,
      "bestTime": "Sunset",
      "placeId": "ChIJ16bUkbVPWxMRqYxyX32_PzM",
      "verifiedHours": "24/7",
      "verifiedOn": "2026-07-30"
    },
    {
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.7192%2C19.6586",
      "lat": 39.7192,
      "lon": 19.6586,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "hasRealPhoto": false,
      "score": "ציון: 8.5",
      "title": "הבית של משפחת דארל (קלאמי) 🏠",
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.6245%2C19.9205",
      "lat": 39.6245,
      "lon": 19.9205,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "hasRealPhoto": false,
      "score": "ציון: 8.8",
      "title": "מערות הים של פלאוקסטריצה 🚤",
    ...
    },
    {
      ...
      "hasRealPhoto": false,
      "score": null,
      "title": "קאסה פרלנטה (Casa Parlante) 🎭",
      "bodyHtml": "<p class=\"text-gray-600 text-sm\">אחוזה מהמאה ה-19 בעיר העתיקה שקמה לתחייה באמצעות רובוטים אנימטרוניים המגלמים את בני המשפחה שגרה בה - סיור פנימי המשחזר את חיי היום-יום של האצולה הקורפיוטית.</p><div class=\"grid grid-cols-2 gap-2 text-xs bg-gray-50 p-2 rounded\">\n          <p>⏱️ <b>משך:</b> כ-45 דקות (סיור מודרך)</p><p>💰 <b>מחיר:</b> לא אומת - בדקו מראש</p><p>🕒 <b>שעות:</b> לא אומת - בדקו מראש</p><p>👥 <b>למי:</b> חובבי היסטוריה ותרבות</p><p>🌡️ <b>עומס:</b> נמוך-בינוני</p><p>🌅 <b>זמן:</b> יום גשום / אחה\"צ</p>\n        </div><details class=\"group bg-blue-50/50 rounded border border-blue-100\">\n          <summary class=\"font-semibold cursor-pointer p-2 text-xs text-blue-900 flex justify-between\">מידע נוסף וטיפים 💡 <span class=\"group-open:rotate-180 transition\">▼</span></summary>\n          <div class=\"p-2 pt-0 text-xs text-gray-700 space-y-2\">\n            <p><b class=\"text-blue-800\">ייחוד:</b> חוויה אינטראקטיבית נדירה - הבית עצמו \"מספר\" את סיפורו באמצעות דמויות אנימטרוניות.</p>\n            <p><b class=\"text-orange-800\">טיפ:</b> אופציה מצוינת ליום גשום בעיר העתיקה, לצד המוזיאון לאמנות אסייתית והמוזיאון הארכיאולוגי.</p>\n            <p><b class=\"text-purple-800\">שווה?</b> חוויה שונה ומעניינת, טובה במיוחד למשפחות עם ילדים בגילאי בית ספר.</p>\n          </div>\n        </details><div class=\"flex flex-wrap gap-2 mt-3\"><a href=\"https://www.google.com/maps/search/?api=1&query=39.625%2C19.925\" class=\"flex-1 min-w-[110px] text-center py-2.5 px-3 rounded-xl font-semibold text-sm transition-colors flex items-center justify-center gap-1.5 hover:bg-blue-100 badge-ion-bg badge-ion-text\">🗺️ מפה</a></div>",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.625%2C19.925",
      "lat": 39.625,
      "lon": 19.925,
      "parking": "Unknown",
  ...
  "gems": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.7977%2C19.6747",
      "lat": 39.7977,
      "lon": 19.6747,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.61%2C19.83",
      "lat": 39.61,
      "lon": 19.83,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.67%2C19.722",
      "lat": 39.67,
      "lon": 19.722,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.778%2C19.9",
      "lat": 39.778,
      "lon": 19.9,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.612%2C19.798",
      "lat": 39.612,
      "lon": 19.798,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.7%2C19.73",
      "lat": 39.7,
      "lon": 19.73,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.4461%2C19.9069",
      "lat": 39.4461,
      "lon": 19.9069,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.665%2C19.73",
      "lat": 39.665,
      "lon": 19.73,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.622%2C19.919",
      "lat": 39.622,
      "lon": 19.919,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.77%2C19.88",
      "lat": 39.77,
      "lon": 19.88,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.45%2C19.95",
      "lat": 39.45,
      "lon": 19.95,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.775%2C19.895",
      "lat": 39.775,
      "lon": 19.895,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.65%2C19.75",
      "lat": 39.65,
      "lon": 19.75,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.665%2C19.735",
      "lat": 39.665,
      "lon": 19.735,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.66%2C19.84",
      "lat": 39.66,
      "lon": 19.84,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.57%2C19.83",
      "lat": 39.57,
      "lon": 19.83,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.75%2C19.77",
      "lat": 39.75,
      "lon": 19.77,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.75%2C19.71",
      "lat": 39.75,
      "lon": 19.71,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.42%2C19.95",
      "lat": 39.42,
      "lon": 19.95,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.72%2C19.83",
      "lat": 39.72,
      "lon": 19.83,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.4%2C19.98",
      "lat": 39.4,
      "lon": 19.98,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.75%2C19.86",
      "lat": 39.75,
      "lon": 19.86,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.65%2C19.86",
      "lat": 39.65,
      "lon": 19.86,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "image": {
        "src": "https://images.pexels.com/photos/1126935/pexels-photo-1126935.jpeg?auto=compress&cs=tinysrgb&w=600",
        "alt": "מפעל הסבון פטוניס (Patounis)"
      },
      "hasRealPhoto": false,
      "typeBadgeHtml": "<span>🧼</span> מפעל מסורתי",
      "name": "מפעל הסבון פטוניס (Patounis)",
      "description": "מפעל סבון משפחתי הפועל בעיר העתיקה של קורפו מאז 1929, עדיין מייצר סבוני שמן זית באופן מסורתי בשיטות ובמכונות מהמאה ה-19. סיור פנימי חינמי חושף את כל שלבי הייצור.",
      "tipHtml": "💡 הסיור עצמו חינמי וקצר - אופציה נהדרת ליום גשום בעיר העתיקה, לצד מוזיאון האמנות האסייתית וקאסה פרלנטה. ניתן לרכוש סבונים בסוף הסיור כמזכרת.",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.624%2C19.921",
      "lat": 39.624,
      "lon": 19.921,
      "parking": "Unknown",
    ...
    },
    {
      ...
      "image": {
        "src": "https://images.pexels.com/photos/1126935/pexels-photo-1126935.jpeg?auto=compress&cs=tinysrgb&w=600",
        "alt": "מוזיאון שמן הזית מברודיס (Mavroudis)"
      },
      "hasRealPhoto": false,
      "typeBadgeHtml": "<span>🫒</span> בית שמן זית",
      "name": "מוזיאון שמן הזית מברודיס (Mavroudis)",
      "description": "מפעל ובית משפחתי בדרום קורפו, בו משפחת מברודיס מייצרת שמן זית מזה דורות. הסיור המקורה כולל הסברים על תהליך הייצור המסורתי וטעימות של סוגי שמנים שונים לצד לחם טרי וגבינות.",
      "tipHtml": "💡 אופציה מומלצת ליום גשום באזור הדרומי, כתחליף לביקור בגני ארמון אכיליון הפתוחים (וחשופים לגשם). כדאי להתקשר מראש כדי לוודא שהסיור פעיל.",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.58%2C19.9",
      "lat": 39.58,
      "lon": 19.9,
      "parking": "Unknown",
      "vibe": [
    ...
    },
    {
      ...
      "image": {
        "src": "https://images.pexels.com/photos/1126935/pexels-photo-1126935.jpeg?auto=compress&cs=tinysrgb&w=600",
        "alt": "מבשלת הבוטיק קורפו מיקרוברואריה (Corfu Microbrewery)"
      },
      "hasRealPhoto": false,
      "typeBadgeHtml": "<span>🍺</span> מבשלת בירה",
      "name": "מבשלת הבוטיק קורפו מיקרוברואריה (Corfu Microbrewery)",
      "description": "מבשלת בירה בוטיקית באזור אריליאס שבצפון האי, המייצרת בירות קראפט מקומיות. מציעה סיורים מודרכים וטעימות תחת קורת גג חמימה - אופציה מקורה נעימה כתחליף לפעילויות חוץ באזור הצפוני.",
      "tipHtml": "💡 שלבו עם ביקור במוזיאון הפולקלור באכראבי הסמוכה ליום מקורה מלא בצפון האי. מומלץ לוודא מראש את זמני הסיורים.",
      "mapsUrl": "https://www.google.com/maps/search/?api=1&query=39.72%2C19.68",
      "lat": 39.72,
      "lon": 19.68,
      "parking": "Unknown",
      "vibe": [
...
// Place-name transliteration aliases (P0.2 cleanup).
//
// A few place names had more than one Hebrew transliteration in circulation
// across the itinerary prose (index.html #itinerary), the FAQ, and this
// file's own card names/bodyHtml - e.g. "אכיליאון" vs "אכיליון". Everything
// has now been normalized to one canonical spelling per place (the key
// below); this map exists so a future search-indexing pass (P0.3) can fold
// each alias into the same search haystack as its canonical name, since
// users may still type the spelling that used to be here.
//
// Shape: { canonicalSpelling: [alternateSpellingsPreviouslyInUse, ...] }
window.CORFU_NAME_ALIASES = {
  'אכיליון': ['אכיליאון'],
  'קמפיילו': ['קמפיאלו'],
  'חלומאס': ['חלומס']
};
