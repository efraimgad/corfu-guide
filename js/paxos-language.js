...
window.PAXOS_LANGUAGE = {
    ...
    // The remaining static-Corfu Language blocks found in the follow-up
    // leakage-fix pass (no-malls intro, restrooms, phrasebook intro) — see
    ...
    // shared static HTML, untouched.
    noMallsIntro: 'לפאקסוס אין קניונים או מתחמי אאוטלט כלל - אפילו פחות מהאפשרויות המצומצמות בעיר קורפו. השופינג מתמצה בכמה חנויות משפחתיות קטנות בסמטאות גאיוס, ובמידה פחותה בלוגוס ובלאקה.',
    restroomsHtml: 'כמו בקורפו, שירותים ציבוריים חינמיים נדירים בפאקסוס מחוץ לגאיוס עצמה - הנוהג המקובל הוא להשתמש בשירותים של בית קפה או טברנה, בדרך כלל בתמורה להזמנת משקה קטן. שימו לב במיוחד בחופי אנטיפאקסוס (וטומי, ורייקה) - חופים קטנים ולא מפותחים, לרוב ללא שום תשתית או שירותים כלל.',
    phrasebookIntro: 'ברוב אזורי התיירות בפאקסוס (גאיוס, לוגוס, לאקה) מדברים אנגלית טובה, אך כמה מילים ביוונית תמיד מתקבלות בחיוך. הנה כמה משפטים שימושיים, עם תעתיק עברי קריא.'
};
