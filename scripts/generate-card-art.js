...
// only with the five hex colors already defined in css/corfu.css's :root
// (see the "MEDITERRANEAN DESIGN SYSTEM" comment there) so no new brand
// color enters the page through an image.
//
